...
class StudylistsController extends \BaseController {
    ...
    public function index()
    {
       ...
       // return View::make('lists.index')->with('lists', $lists);
        return View::make('studylists.index');
    }
    ...
    {
        return View::make('studylists.create');
    }
    ...
    public function show($id)
    {
        ...
        return View::make('studylists.show');
    }
    ...
    public function edit($id)
    {
        ...
        return View::make('studylists.edit');
    }
